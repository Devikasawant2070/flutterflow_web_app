...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: HomepagepWidget.routeName,
          path: HomepagepWidget.routePath,
          builder: (context, params) => HomepagepWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: StaphomeWidget.routeName,
          path: StaphomeWidget.routePath,
          builder: (context, params) => StaphomeWidget(),
        ),
        FFRoute(
